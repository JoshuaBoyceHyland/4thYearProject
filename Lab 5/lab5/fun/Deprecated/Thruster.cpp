...
Thruster::Thruster(std::string t_texturePath)
{
...
void Thruster::draw(sf::RenderWindow& t_window)
{
...
void Thruster::setRotation(float t_rotation)
{
	m_rotation = t_rotation;
}

void Thruster::setPostion(sf::Vector2f t_position)
{
	m_position = t_position;

}

sf::Vector2f Thruster::getConnectionPount(int t_index)
{
	return RotationMath::rotatedVector(m_attributes.connectionPoints[t_index], m_rotation);
}

void Thruster::setUpBody(std::string t_texturePath)
{
